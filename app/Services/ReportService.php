...
class ReportService
{
    ...
    public function salesByItems(): JsonResponse
    {
    ...
    public function salesByCategories(): JsonResponse
    {
        $company_id = $this->loggedInUser->company_id;
        // Initially the query was like this
    ...
    public function refundsByItems(): JsonResponse
    {
        $company_id = $this->loggedInUser->company_id;
        // Initially the query was like this
    ...
    public function refundsByCategories(): JsonResponse
    {
        $company_id = $this->loggedInUser->company_id;
    ...
    public function salesByBranches(): JsonResponse
    {
        $transactionsByBranch = DB::select('SELECT
            ...
            GROUP BY branches.name', [$this->loggedInUser->company_id, $this->start_date, $this->start_date, $this->end_date, $this->loggedInUser->company_id]);
